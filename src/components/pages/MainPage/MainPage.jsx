    ...
    <div className="main-page">
      ...
      <div className="content-container">
        ...
        <div className="menu-buttons">
          <button className="menu-button play-button" onClick={onPlayClick}>
            <span className="button-text">PLAY</span>
          </button>
          
          <button className="menu-button learn-button" onClick={onLearnClick}>
        ...
        <div className="bottom-buttons">
          ...
          <button className="icon-button rules-button" onClick={handleLearnClick}>
            <span className="icon">📖</span>
          </button>
        </div>
      </div>
